...
export class SkyrimMiniGame extends Minigame {
  bgDiv: HTMLElement;
  outerlockDiv: HTMLElement;
  innerlockDiv: HTMLElement;
  userDataDiv: HTMLElement;
  lockHoleDiv: HTMLElement;
  difficultyRating: string;
  numLockPicks: number;
  timeLimit: number;
  timerInstance: NodeJS.Timer;
  pickDiv: HTMLElement;
  tensionDiv: HTMLElement;
  lockPickLife: number;
  wrenchAngle: number;
  pickRange: number;
  pickAlmost: number;
  ...
  constructor(config: minigameConfig) {
    super(config);
    this.difficultyRating = config.gameData.difficulty;
  }
  ...
  createElement(): void {
    ...
    this.myDiv.appendChild(this.bgDiv);
    ...
    this.myDiv.appendChild(this.outerlockDiv);
    ...
    this.myDiv.appendChild(this.userDataDiv);
  ...
  updateLockPickProgress() {
    ...
    progression.innerText = this.lockPickProgress;
  }

  updateTimer() {
    let myTimer = document.getElementById("timer");
    myTimer.innerText = `${this.timeLimit}`;
  }
  ...
  updateLockPickLife() {
    ...
    lpl.innerText = `${this.lockPickLife}`;
  }
